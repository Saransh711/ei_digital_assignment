...
import 'package:ei_digital_assignment/presentation/widgets/detail_panel/landscape/landscape_profile_tab.dart';
import 'package:ei_digital_assignment/presentation/widgets/detail_panel/landscape/landscape_tab_bar.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

/// Landscape orientation guest detail panel
class LandscapeGuestDetail extends StatelessWidget {
  final Guest guest;

  const LandscapeGuestDetail({super.key, required this.guest});
              ...
              child: BlocBuilder<TabBloc, TabState>(
                builder: (context, tabState) {
                  return IndexedStack(
                    ...
                    children: [
                      LandscapeProfileTab(guest: guest),
